              ...
              <md-content layout-padding style="background-color: #ffff">
                <form name="projectForm" action="" method="POST">
                    ...
                    <div ng-show="{{dataset}}" ng-repeat="data in dataset">
                      ...
                      <!-- <div layout="row">
                        <div class="col-sm-6 push-sm-6" ng-if="nguyenlieumoi">
                          <div class="row">
                            <md-input-container class="md-block">
                              <label>Mã nguyên liệu</label>
                              <input required name="manguyenlieumoi" ng-model="manguyenlieumoi">
                              <div ng-messages="projectForm.manguyenlieumoi.$error">
                                <div ng-message="required">Bắt buộc</div>
                              </div>
                            </md-input-container>
                          </div>
                      ...
                      <div layout="row">
                          <md-input-container flex="33">
                            ...
                            <input type="number" required name="soluong[]" ng-model="soluong">
